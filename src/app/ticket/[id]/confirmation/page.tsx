...
function ConfirmationContent() {
  ...
  // Identifier can be either the numeric attendee ID from the path, or the transaction ID from the query params
  const identifier = params.id || searchParams.get('transaction_id');
